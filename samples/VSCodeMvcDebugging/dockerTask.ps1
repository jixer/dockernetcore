...
.PARAMETER Clean
Removes the image vscodemvcdebugging and kills all containers based on that image.
...
Build a Docker image named vscodemvcdebugging
#>
...
$imageName="vscodemvcdebugging"
$projectName="vscodemvcdebugging"
$serviceName="vscodemvcdebugging"
